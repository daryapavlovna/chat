...
const me: User      = new User('Juliet', 'assets/img/img_avatar2.png');
const ladycap: User = new User('Lady Capulet', 'assets/img/img_avatar2.png');
const echo: User    = new User('Echo Bot', 'assets/img/img_avatar.png');
const rev: User     = new User('Reverse Bot', 'assets/img/img_avatar.png');
const wait: User    = new User('Waiting Bot', 'assets/img/img_avatar.png');
